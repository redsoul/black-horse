...
const PieceService = require('../../source/services/piece-service.js');
const configs = require('../../source/configurations');

describe('Board Mode', function () {
    ...
    describe('getPieceByRowColumn function - ', function () {
        ...
        test('tests starting fen positions', function () {
            expect(board.getPieceByRowColumn(1, 1)).toBe(configs.pieces.wR);
            expect(board.getPieceByRowColumn(2, 1)).toBe(configs.pieces.wP);
            expect(board.getPieceByRowColumn(1, 8)).toBe(configs.pieces.wR);
            expect(board.getPieceByRowColumn(7, 1)).toBe(configs.pieces.bP);
            expect(board.getPieceByRowColumn(8, 1)).toBe(configs.pieces.bR);
            expect(board.getPieceByRowColumn(8, 8)).toBe(configs.pieces.bR);
        });
    });
