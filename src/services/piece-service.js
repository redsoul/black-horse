...
const startingPieceVal = [0, pawnValue[0], bishopValue[0], knightValue[0], rookValue[0], queenValue[0], kingValue[0],
    pawnValue[0], bishopValue[0], knightValue[0], rookValue[0], queenValue[0], kingValue[0]];
...
class PieceService {
    ...
    getStartingMaterial() {
        return this.getStartingPawnMaterial() + startingPieceVal[2] * 4 + startingPieceVal[3] * 4 + startingPieceVal[4] * 4 + startingPieceVal[5] * 2 + startingPieceVal[6] * 2;
    }
    ...
    gameStage(board) {
        ...
        return 1.0 - (board.getPieceMaterial(configs.colors.black) + board.getPieceMaterial(configs.colors.white) - totalKingValue) /
